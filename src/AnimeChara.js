...
const character_specific_msgs = {
    '/Madoka-Runes/assets/105px-Tomoe_Mami_16.png': [
        "已经没什么好怕的了",
        "要来杯红茶吗",
        "在同等条件下，你觉得你能战胜我吗？",
        "既然要实现他人的愿望，就更应该搞清楚自己追求的是什么，你是希望他能实现你的梦想，还是想借实现他的梦想施恩于他呢。要是没弄清楚这一点，迟早有一天你会后悔的。",
    ],
    '/Madoka-Runes/assets/105px-Miki_Sayaka_16.png': [
        "我，真是个笨蛋。",
        "小圆可是要当我的老婆的❤",
        "现在想来，那时的我，还什么都不明白，期盼奇迹的意义，以及代价。",
        "即便如此！有一件事我绝对不会忘记……晓美焰，你是恶魔——！",
    ],
    '/Madoka-Runes/assets/105px-Akemi_Homura_16.png': [
    ...
    '/Madoka-Runes/assets/105px-Kaname_Madoka_16.png': [
        ...
        "这是这样的我最后找到的答案。相信我，我保证，焰为我所做的一切绝对不会白费的。",
    ],
    '/Madoka-Runes/assets/105px-Sakura_Kyouko_16.png': [
