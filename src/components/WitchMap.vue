...
<script>
  export default {
    ...
    data() {
      return {
        points: [
          ...
          { id: 3, x: 35, y: 45, name: '见泷原入口', des: '见泷原入口，支持市民生活的交通要道', info: '◈人鱼的魔女Oktavia von Seckendorff<br>※map\\Sayaka-head.png变成魔女', icon: 'map/车站.png' },
          { id: 4, x: 65, y: 63, name: '巴麻美家', des: '巴麻美居住的公寓', icon: 'map/家.png' },
          { id: 5, x: 45, y: 25, name: '见泷原市综合医院', info: '◈零食的魔女 CHARLOTTE<br>※map\\Mami-head.png牺牲<br>※【天台】map\\Sayaka-head.png变成魔法少女<br>【天台】上条恭介康复后第一次拉琴', icon: 'map/医院.png' },
          { id: 6, x: 30, y: 36, name: '晓美焰家', des: '晓美焰居住的房间', icon: 'map/家.png' },
          { id: 7, x: 56, y: 46, name: '闹市', des: '聚集了学生和上班族的闹市', info: '◈玫瑰园的魔女GERTRUD<br>◈【小巷】银之魔女GISELA<br>【CD店】map\\Sayaka-head.png常去的CD店<br>【游戏中心】map\\Kyoko-head.png常去的跳舞机<br>【酒店】map\\Kyoko-head.png居住所在', icon: 'map/闹市.png' },
          { id: 8, x: 24, y: 76, name: '美树沙耶香家', des: '美树沙耶香和家人居住的公寓', icon: 'map/家.png' },
          { id: 9, x: 94, y: 40, name: '工业地带', des: '各类工厂林立的工业地带', info: '◈影之魔女Elsa Maria<br>◈【废工厂】箱之魔女H.N. ELLY (KIRSTEN)<br>【废工厂】魔法少女map\\Sayaka-head.png首战<br>【军事基地】map\\Homura-head.png获取军火', icon: 'map/工厂.png' },
          { id: 10, x: 10, y: 46, name: '公园', des: '车站附近的公园，见泷原市民休息的场所', info: 'TV第三集map\\Homura-head.pngmap\\Mami-head.png对持<br>仁美对上条恭介告白<br>TV第八集map\\Homura-head.pngmap\\Madoka-head.png对话<br>map\\Kyube-head.png被打成筛子', icon: 'map/公园.png' },
          { id: 11, x: 67, y: 31, name: '干线道路及步行天桥', info: '※众人首次得知灵魂宝石作用<br>map\\Sayaka-head.png map\\Kyoko-head.png战斗', icon: 'map/桥梁.png' },
          { id: 12, x: 80, y: 50, name: '展望台', des: '一览见泷原风貌的展望台', info: 'TV第五集map\\Kyoko-head.png观察点', icon: 'map/瞭望台.png' },
          { id: 13, x: 33, y: 68, name: '中学的上学路', info: 'map\\Madoka-head.png-仁美-map\\Sayaka-head.png固定刷新点', icon: 'map/道路.png' },
          { id: 14, x: 80, y: 33, name: '河川敷', des: '沿着见泷原河河堤而筑的河川敷，附近有游乐场', info: '小说版确定为姬名河<br>TV第五集map\\Madoka-head.png map\\Sayaka-head.png对话', icon: 'map/风力发电站.svg' },
          { id: 15, x: 95, y: 63, name: '教会', des: '见泷原郊外的教会', info: '※map\\Kyoko-head.png及其家人曾经所在的教会<br>TV第七集map\\Kyoko-head.png map\\Sayaka-head.png谈话', icon: 'map/教堂.svg' },
        ],
    ...
    methods: {
      ...
      formatInfo(info) {
        return info
          .replace(/map[\\/][\w\-]+\.(png|svg|jpg)/g, (match) => {
            const normalized = match.replace(/\\/g, '/');
            return `<img src="${import.meta.env.BASE_URL}${normalized}" alt="HEADER" style="height:2.5em;vertical-align:middle;">`;
          })
